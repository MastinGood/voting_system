    ...
    <div class="row">
        <div class="col-md-4">
            ...
            if(isset($_POST['submit'])) {
                ...
                $conformation_code    = bin2hex(random_bytes(4));
               

                $insertVoter = new Voters();
                $rtnInsertVoter = $insertVoter->INSERT_VOTER($name, $course, $year, $stud_id, $conformation_code);
            }
            ?>
            <h4>Add Voters</h4><hr>
            <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" role="form">
                ...
                <div class="form-group-sm">
                    ...
                    <select required name="course" class="form-control">
                        ...
                        <option value="BSMaE">BSMaE</option>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td><?php echo $rowVoter['conformation_code']; ?></td>
